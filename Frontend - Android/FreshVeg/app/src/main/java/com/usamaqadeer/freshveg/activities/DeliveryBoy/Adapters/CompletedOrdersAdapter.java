...
public class CompletedOrdersAdapter extends RecyclerView.Adapter<CompletedOrdersAdapter.ViewHolder> {
    ...
    public CompletedOrdersAdapter(Context context, List<OrderAssignsModel> orderAssignsList){
    ...
    @Override
    public void onBindViewHolder(@NonNull CompletedOrdersAdapter.ViewHolder view, int position) {
