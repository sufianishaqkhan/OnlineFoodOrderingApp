        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (etEmail.getText().toString().isEmpty() == true || etPassword.getText().toString().isEmpty() == true) {
                    ...
                    adminLogin(etEmail.getText().toString(), etPassword.getText().toString());
                }
            }
        });
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (etPassword.getText().toString().isEmpty() == true || etEmail.getText().toString().isEmpty() == true) {
                    ...
                    Intent intent = new Intent(DashboardActivity.this, DeliveryBoyActivity.class);
        ...
        btnReset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!checkCredientials()) {
                    Toast.makeText(getApplicationContext(), "Please fill credentials carefully", Toast.LENGTH_SHORT).show();
                } else {
                    dialog.dismiss();
    ...
    private void adminLogin(String email, String password){
        ...
        call.enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                if (response.body().equals("0")) Toast.makeText(DashboardActivity.this, "Login failed. Please try again later.", Toast.LENGTH_SHORT).show();
                else startActivity(new Intent(DashboardActivity.this, AdminDashboardActivity.class));
            }
